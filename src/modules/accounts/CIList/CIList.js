                    ...
                    {list.map((listItem) => {
                      return (
                        ...
                        >
                          ...
                          <td>{listItem.name}</td>
                          <td>{listItem.is_fees_paid ? (
                            <p>paid</p>
                              // <Button
                              //   onClick={() => { 
                              //     history.push(`${url.url}/receipt/${'COGNITIVE INTERNSHIP'}/${listItem.id}`)
                              //   }
                              //   }
                              // >
                              //   VIEW DETAILS
                           ...
                           <Button
                                onClick={() => { 
                                  history.push(`${url.url}/reciept_list/${'COGNITIVE INTERNSHIP'}/${listItem.register_no}`)
