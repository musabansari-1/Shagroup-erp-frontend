...
const SPList = ({url}) => {
  ...
  const fetchData = () => {
    ...
    // }
    axios
      .get('administration/codelab_systems/student_projects/student_projects/', headers)
      .then((res) => {
        console.log(res.data);
        setList(res.data);
      })
                          ...
                          <td>
                           <Button
                                onClick={() => { 
                                  ...
                                  history.push({
                                    pathname: `/accounts/reciept_list/${'STUDENT PROJECT'}/${listItem.register_no}`,
                                    // search: '?query=abc',
                                });
                                  // history.push(`${url.url}/receipt/${'ACADEMIC INTERNSHIP'}/${listItem.id}`)
                                }
