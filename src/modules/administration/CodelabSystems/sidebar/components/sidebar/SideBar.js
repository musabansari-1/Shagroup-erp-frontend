...
const SideBar = ({ isOpen, toggle }) => (
  <div className={classNames("sidebar", { "is-open": isOpen })}>
    <div className="sidebar-header">
      ...
      <h1 style={{fontWeight: '800'}}>SHA <br />GROUP</h1>
    ...
    <div className="side-menu">
      <Nav vertical className="list-unstyled pb-3">
        ...
        {/* <SubMenu title="Internships" icon={faChalkboardTeacher} items={submenus[2]} /> */}
        {/* <SubMenu title="Workshops" icon={faLaptopCode} items={submenus[3]} /> */}
        {/* <NavItem>
          <NavLink tag={Link} to={"/reciept"}>
  ...
  [
    {
      ...
      target: "/academic_internship",
    },
    {
      title: "Cognitive Internship",
      target: "/cognitive_internship",
    },
    {
      title: "Employee Internship",
      target: "/employee_internship",
    },
  ],
  [
    {
      title: "Academic Workshop",
      target: "/academic_workshop",
    },
    {
      title: "Cognitive Workshop",
      target: "/cognitive_workshop",
    },
   ],
];
